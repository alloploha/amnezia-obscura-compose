...
- ранний необязательный профиль Xray с постоянным серверным состоянием и базовым управлением клиентами
...
Хелперы для управления клиентами и импорт состояния из Amnezia еще остаются запланированной работой.
